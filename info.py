...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://DS:DS@cluster0.ayauj.mongodb.net/myFirstDatabase?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "DS")
